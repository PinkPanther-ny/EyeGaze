...
def build_trt_engine(onnx_file_path, engine_file_path):
    ...
    with (trt.Builder(TRT_LOGGER) as builder,
        ...
        profile.set_shape('input', (1, 3, TARGET_SIZE, TARGET_SIZE), (1, 3, TARGET_SIZE, TARGET_SIZE),
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--mode', type=int, choices=[1, 2, 3, 4], default=4,
                        help='Conversion option: 1 - ONNX, 2 - ONNX and TensorRT, '
                             '3 - TorchScript, 4 - ONNX, TensorRT, and TorchScript')
